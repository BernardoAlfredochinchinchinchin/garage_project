                                ...
                                <div class="border p-3">
                                    <div class="mb-2">
                                        <h4 class="font-semibold">
                                            {{ \Carbon\Carbon::parse($afspraak->datum)->format('d-m-Y') }} - {{ $afspraak->naam }}
                                        </h4>
                                    ...
                                    <form action="{{ route('monteur.store', $afspraak->id) }}" 
                                          method="POST"
                                          class="grid gap-2 md:grid-cols-3 md:items-end">
                                        @csrf
                                        ...
                                        <button 
                                            type="submit" 
                                            class="border px-3 py-2 text-sm {{ $afspraak->status === 'Afgerond' ? 'bg-gray-300 text-gray-600 cursor-not-allowed' : 'bg-gray-200' }}"
                                            {{ $afspraak->status === 'Afgerond' ? 'disabled' : '' }}>
